...
- Es una versión 2.0 ya que en el 1er año de ciclo hice un CRUD con la idea de hacer una app de gestión para ópticas. [Enlace a CRUD](https://github.com/Miguelgm1693/CRUD_OptiManager).
